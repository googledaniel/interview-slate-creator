...
//Thu/Fri to do: make this dashboard hold each interview and link to each one. Make a schema to hold the data.

export default function InterviewDashboard(props) {
	return (
		<div>
